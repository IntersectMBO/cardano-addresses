...
-- Original: Crypto.Encoding.BIP39.English
--
-- Changed: Vect 2048 String -> Vector Text
module Cardano.Address.Crypto.BIP39.English
    ( english
    ) where
...
english :: Dictionary
english = Dictionary
    { dictionaryWordToIndex = \word ->
        case Map.lookup word wordMap of
            Just x -> Right x
...
wordMap = Map.fromList $ Data.List.zip wordList (Data.List.map (wordIndex . fromIntegral) [0 :: Word16 .. 2047])
