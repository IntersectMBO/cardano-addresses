...
spec = do
    ...
    let Just index2 = fromWord32 @(Index 'Soft _) 0x00000001
    ...
    let Just index3 = fromWord32 @(Index 'Soft _) 0x00000002
    ...
    let Just index4 = fromWord32 @(Index 'Soft _) 0x00000003
